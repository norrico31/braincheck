...
export default function Subscribe() {
    ...
    return (
        <Box sx={{ height: '100svh', display: 'flex', position: 'relative' }}>
            <IconButton children={<CloseIcon />} sx={{ position: 'absolute', top: 10, right: 10 }} />
            <Box width='50%' sx={{ background: '#fdfdda', padding: '0 10px' }} textAlign='center'>
                ...
                <Box mt={4} textAlign='center'>
                    <Typography variant='caption' sx={{ color: '#757575ec' }}>We're committed to your privacy and will not share your data with third parties. <br /> See our <b><Link to='/privacy-policy' style={{ color: 'inherit' }}>Privacy Policy</Link></b></Typography>
                </Box>
                <Box mt={4} textAlign='center'>
                    <Typography component='p' sx={{ color: '#757575ec' }}><b><Link to='/privacy-policy' style={{ color: 'inherit' }}>Click here</Link></b> if your download did not start automatically</Typography>
                </Box>
            </Box>
